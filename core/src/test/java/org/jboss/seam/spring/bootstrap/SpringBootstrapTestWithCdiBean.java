...
public class SpringBootstrapTestWithCdiBean {
    ...
    public static Archive<?> deployment() {
        return ShrinkWrap.create(WebArchive.class, "test.war")
                ...
                .addClasses(SpringConfigurationContextProducer.class, ContextInjected.class , Configuration.class,
                        SpringContext.class, SpringContextBootstrapExtension.class, Web.class, SpringBeanInjectedWithCdiBean.class,
